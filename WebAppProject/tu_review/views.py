...
def study(request):
    ...
    top_courses = Course.objects.annotate(avg_rating=Avg("reviews__interest")).order_by(
        "-avg_rating"
    )[:3]
    return render(
        request, "study.html", {"faculties": faculties, "top_courses": top_courses}
    )
...
def faculty_view(request, faculty_id):
    ...
    return render(
        request, "study_faculty.html", {"faculty": faculty, "courses": courses}
    )
...
def restaurant_list(request):
    ...
    return render(
        ...
        {"restaurants": restaurants, "top_restaurants": top_restaurants},
    )
...
def post_review(request, restaurant_id):
    ...
    return render(
        request, "restaurant_post_review.html", {"form": form, "restaurant": restaurant}
    )
